...
if (!$is_member_login) {
    ...
    echo '<div class="collection-list"><div class="item_list">';
    echo showLoanList();
    echo '<form name="loanHiddenForm" method="post" action="lib/contents/extend.php"><input type="hidden" name="process" value="extend" /><input type="hidden" name="loanID" value="" /></form>';
    echo '</div>';
    echo '<div class="tagline">';
