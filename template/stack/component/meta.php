<!-- Modified from meta.php from SLiMS Default Template -->
<!-- Page Title
============================================= -->
...
<!-- Script
============================================= -->
<script src="<?php echo $sysconf['template']['dir']; ?>/stack/asset/js/jquery.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/stack/asset/js/mobilecheck.js"></script>
...
<!-- Style
============================================= -->
<!-- <link rel="stylesheet" type="text/css" href="<?php echo $sysconf['template']['dir'];?>/stack/asset/core.css" /> -->
<link rel="stylesheet" type="text/css" href="<?php echo $sysconf['template']['dir'];?>/stack/asset/core.min.css" />