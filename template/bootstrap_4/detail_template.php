...
<br>
  <!-- Availability
  ============================================= -->  
  <h4><i class="fa fa-check-circle-o"></i> <?php echo __('Availability'); ?></h4>
  ...
  <h4><i class="fa fa-circle-o"></i> <?php echo __('Detail Information'); ?></h4>
  <div class="row">
  <div class="col-lg-12">  
...
<br>
  <!-- Related biblio data
  ============================================= -->  
  <h4><i class="fa fa-circle-o"></i> <?php echo __('Other version/related'); ?></h4>
  ...
  <!-- Attachment
  ============================================= -->  
  <h4><i class="fa fa-arrow-circle-o-down"></i> <?php echo __('File Attachment'); ?></h4>
  ...
  <h4><i class="fa fa-comments-o"></i> <?php echo __('Comments'); ?></h4>
