...
$sysconf['print']['barcode']['barcode_box_width'] = 3.75;
$sysconf['print']['barcode']['barcode_box_height'] = 2.75;
$sysconf['print']['barcode']['barcode_include_header_text'] = 0; // change to 0 if dont want to use header in each barcode
$sysconf['print']['barcode']['barcode_cut_title'] = 10; // maximum characters in title to appear in each barcode. change to 0 if you dont want the title cutted
...
$sysconf['print']['barcodegen']['items_per_row'] = 1;
